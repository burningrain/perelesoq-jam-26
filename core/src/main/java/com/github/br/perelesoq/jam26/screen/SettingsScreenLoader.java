...
public class SettingsScreenLoader implements AssetsLoader {
    ...
    public void loadAssets(AssetManager assetManager) {
        ...
        assetManager.load(Resources.Tiled.SETTINGS, TiledMap.class, params);
    }

    @Override
    public void unloadAssets(AssetManager assetManager) {
        assetManager.unload(Resources.Tiled.SETTINGS);
    }
