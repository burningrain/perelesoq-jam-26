...
public class LevelBossScreenLoader implements AssetsLoader {
    @Override
    public void loadAssets(AssetManager assetManager) {
        TmxMapLoader.Parameters params = new TmxMapLoader.Parameters();
        params.textureMinFilter = Texture.TextureFilter.Nearest;
        params.textureMagFilter = Texture.TextureFilter.Nearest;
        assetManager.load(Resources.Tiled.LEVEL_BOSS, TiledMap.class, params);
    }

    @Override
    public void unloadAssets(AssetManager assetManager) {
        assetManager.unload(Resources.Tiled.LEVEL_BOSS);
    }
